...
ReactDOM.render(
  <React.StrictMode>
    {" "}
    {/* A component used to wrap the app it notes that mounting to root is not a guaranteed action */}
    <Router>
      {" "}
      {/* Enables Different Routes on our app ie '/about' or w/e with a nice api */}
      <App />{" "}
      {/* The first component to be mounted in the app, I think of this as the wrapper of all of our work */}
    </Router>
  </React.StrictMode>,
